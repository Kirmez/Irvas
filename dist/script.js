...
/* harmony export */ });
const modals = () => {
  function bindMondal(triggerSelector, modalSelector, closeSelector) {
  ...
  bindMondal(".popup_engineer_btn", ".popup_engineer", ".popup_engineer .popup_close");
  bindMondal(".phone_link", ".popup", ".popup .popup_close");
